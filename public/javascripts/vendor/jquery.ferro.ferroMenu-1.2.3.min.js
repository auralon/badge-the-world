...
if (isMobileOut()) {
    ...
    var t = {
        ferroMenuCreate: function(t) {
            ...
            e("body").append("<a id='" + E + "' data-ferromenuitem='" + r + "' class='ferromenu-controller " + g + " " + y + "' href='javascript:void(0);'><div class='label'>key</div></a>");
            e(r + " > li").css({
                opacity: 0
            });
            _();
            ...
            C(N, e("#" + E).get(0), O);
            D("menuready");
            e.fn.ferroMenu.refreshMenu = function() {
                _()
            };
